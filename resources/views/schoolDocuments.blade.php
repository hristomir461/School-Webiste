<x-app-layout>
    ...
    <table class="table table-dark">
        ...
        <tr>
            <td style="text-align: center">{{$schoolDocument->title}}</td>
                    ...
                    <div class="x-app-layout-dialog">
                        ...
                        <section class="x-app-layout-content" style="width: 90%;">
                            <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
                                    <iframe style="width: 100%; height: 90vh; border: 1px solid black;margin-left: 100px" src="./storage/{{$schoolDocument->file}}"></iframe>
                                </div>
                        </section>
                    </div>
                </div>
